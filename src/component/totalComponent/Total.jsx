...
export const Total = () => {
  ...
  return (
    <div className="md:flex md:w-full w-full space-y-4 text-2xl  mt-10 md:text-center justify-between ">
      <div
        className={`md:flex flex md:w-70 p-8 border border-gray-300/40 ${
        ...
        <div className="grid grid-cols-1 text-left text-5xl">
          {totalUser}
          <span className="text-sm capitalize font-extralight font-roboto">
            Total users
          </span>
        </div>
      </div>
      ...
      <div
        className={`flex md:w-70 p-8 border border-gray-300/40 ${
          theme === "light" ? "bg-white text-black" : "bg-gray-800 text-white"
        }  rounded-md shadow-1 items-center space-x-3`}>
