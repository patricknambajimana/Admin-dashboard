  ...
  return (
    <div className={` overflow-hidden md:w-full md:pl-80 md:pt-30 md:pr-10 p-6 pt-20 ${theme === "light" ? "bg-white text-black"
        ...
        <div className='bg-primary-500 w-full rounded-2xl'>
            ...
            <Package  className=' bg-primary-400  text-white rounded-md md:p-2  md:w-12 md:h-12'/>
        ...
        <div className={`mt-10  w-full  border-neutral-200 shadow-1 rounded-md ${theme === "light" ? "bg-white text-black"
                    : "bg-gray-800 text-white"
                }`}>
            <h2 className='capitalize text-xl font-roboto text-left p-4 rounded-t-2xl border border-gray-300/40 shadow-1xl'>recents added products</h2>
             <div>
              <RecentProduct />
             </div>
        </div>
        <div className='mt-10 w-full border border-gray-300/40  shadow-1xl rounded-t-2xl'> 
         ...
         <div className={`flex rounded-t-2xl justify-between capitalize text-3x p-4 ${theme === "light" ? "bg-white text-black"
                    : "bg-gray-800 text-white"
                }` }>
